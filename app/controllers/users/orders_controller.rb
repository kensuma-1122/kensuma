  ...
  class OrdersController < Users::Base
    ...
    def order_params
      params.require(:order).permit(
        ...
        :general_safety_responsible_person_name, :vice_president_name, :vice_president_name, :vice_president_company_name, :secretary_name,
        :health_and_safety_manager_name, :general_safety_agent_name, :supervisor_name, :supervisor_apply, :site_agent_name,
        :site_agent_apply, :supervising_engineer_name, :supervising_engineer_check, :supervising_engineer_assistant_name, :professional_engineer_name,
        :professional_engineer_construction_details, :safety_officer_name, :safety_officer_position_name, :general_safety_manager_name, :general_safety_manager_position_name,
        :safety_manager_name, :safety_manager_position_name, :health_manager_name, :health_manager_position_name, :health_and_safety_promoter_name,
        :health_and_safety_promoter_position_name, :confirm_name, :accept_confirm_date, :subcontractor_name
      )
    end
  end
end
