      ...
      context '入力内容が正しい場合' do
        it '登録ができ、詳細画面が表示される' do
          ...
          expect {
            ...
            select Time.now.year - 35, from: 'worker[birth_day_on(1i)]'
            select Time.now.month, from: 'worker[birth_day_on(2i)]'
            select Time.now.day, from: 'worker[birth_day_on(3i)]'
            ...
            select Time.now.year - 10, from: 'worker[hiring_on(1i)]'
            select Time.now.month, from: 'worker[hiring_on(2i)]'
            select Time.now.day, from: 'worker[hiring_on(3i)]'
            ...
            select Time.now.year, from: 'worker[worker_licenses_attributes][0][got_on(1i)]'
            select Time.now.month, from: 'worker[worker_licenses_attributes][0][got_on(2i)]'
            select Time.now.day, from: 'worker[worker_licenses_attributes][0][got_on(3i)]'
            # WorkerSkillTraining
            select 'サンプル技能講習', from: 'worker[worker_skill_trainings_attributes][0][skill_training_id]'
            select Time.now.year, from: 'worker[worker_skill_trainings_attributes][0][got_on(1i)]'
            select Time.now.month, from: 'worker[worker_skill_trainings_attributes][0][got_on(2i)]'
            select Time.now.day, from: 'worker[worker_skill_trainings_attributes][0][got_on(3i)]'
            # WorkerSpecialEducation
            select 'サンプル特別教育', from: 'worker[worker_special_educations_attributes][0][special_education_id]'
            select Time.now.year, from: 'worker[worker_special_educations_attributes][0][got_on(1i)]'
            select Time.now.month, from: 'worker[worker_special_educations_attributes][0][got_on(2i)]'
            select Time.now.day, from: 'worker[worker_special_educations_attributes][0][got_on(3i)]'
            # WoekerMedical
            select Time.now.year, from: 'worker[worker_medical_attributes][med_exam_on(1i)]'
            select Time.now.month, from: 'worker[worker_medical_attributes][med_exam_on(2i)]'
            select Time.now.day, from: 'worker[worker_medical_attributes][med_exam_on(3i)]'
            ...
            select Time.now.year, from: 'worker[worker_medical_attributes][special_med_exam_on(1i)]'
            select Time.now.month, from: 'worker[worker_medical_attributes][special_med_exam_on(2i)]'
            select Time.now.day, from: 'worker[worker_medical_attributes][special_med_exam_on(3i)]'
            # WorkerExam
            select 'サンプル特別健康診断', from: 'worker[worker_medical_attributes][worker_exams_attributes][0][special_med_exam_id]'
            select Time.now.year, from: 'worker[worker_medical_attributes][worker_exams_attributes][0][got_on(1i)]'
            select Time.now.month, from: 'worker[worker_medical_attributes][worker_exams_attributes][0][got_on(2i)]'
            select Time.now.day, from: 'worker[worker_medical_attributes][worker_exams_attributes][0][got_on(3i)]'
